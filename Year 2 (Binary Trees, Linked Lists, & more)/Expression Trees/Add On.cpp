...
{
    if(current->getData() == '+' || current->getData() == '-' || current->getData() == '*' || current->getData() == '/' || current->getData() == 'd' || current->getData() == 'f')
    {
        if(current->getLeft()->getData() == '+' || current->getLeft()->getData() == '-' || current->getLeft()->getData() == '*' ||
           current->getLeft()->getData() == '/' || current->getLeft()->getData() == 'd' || current->getLeft()->getData() == 'f')
        {
        ...
        else if(current->getData() == 'f')
        {
            ...
            total = current->getLeft()->getValue();
            int temp;
            for(int i=1; i<=factorial-1; i++)
            {
                temp = total*(factorial-i);
                total = temp;
