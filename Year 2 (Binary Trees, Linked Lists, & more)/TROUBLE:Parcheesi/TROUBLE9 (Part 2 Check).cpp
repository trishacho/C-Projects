...
Board::Board()
    : players {{5,8,'B',"1"}, {2,2,'B',"2"}, {8,8,'G',"1"}, {7,9,'G',"2"}, {2,8,'Y',"1"}, {2,7,'Y',"2"},
                {4,8,'R',"1"}, {3,8,'R',"2"}}
{
...
void Board::moveNormal(int currentPlayer)
{
    ...
    int new_x, new_y;
    if(current_y == 2) // top row
    {
        if((current_x + distance) <= 8)
        {
            if(current_x <= 5 && (current_x + distance) >= 5 && (currentPlayer == 0 || currentPlayer == 1))
            {
                new_x = 5;
                new_y = current_y + (distance - (5 - current_x)); //turning a goal
                if(new_y > 5)
                {
//                    cout << "newX: " << new_x << "newY: " << new_y;
                    new_y = 2;
                }
            }
            else
            {
                ...
                new_y =  current_y;  // does not change (not turning anything)
            }
        }
        else
        {
            ...
            {
                new_x = 5;
                new_y = current_y + (distance - (5 - current_x)); //turning a corner
                if(new_y > 5)
                {
//                    cout << "newX1: " << new_x << "newY1: " << new_y;
                    new_y = 2;
                }
            }
            else
            {
                new_x  = 8;
                new_y = current_y + (distance - (8 - current_x)); //turning a goal
            }
        }
    }
    else if(current_x == 8)
    {
        ...
        {
            if(current_y <= 5 && (current_y + distance) >= 5 && (currentPlayer == 2 || currentPlayer == 3))
            {
                new_x = current_x - (distance - (5 - current_y));
                new_y = 5;
                cout << "newX: " << new_x << "newY: " << new_y;
                if(new_x < 5)
                {
    ...
    else if(current_y == 8)
    {
        ...
        {
            if(current_x >= 5 && (current_x + distance) >= 5 && (currentPlayer == 4 || currentPlayer == 5))
            {
                new_x = 5;
                new_y = (5 - distance) + (current_x - 2);
                if(new_y < 5)
                {
                    new_x = 5;
                    new_y = 8;
    ...
    else if(current_x == 2)
    {
        ...
        {
            if(current_y >= 5 && (current_y + distance) >= 5 && (currentPlayer == 6 || currentPlayer == 7))
            {
                new_x = current_x + (distance - (current_y - 5));
                new_y = 5;
                if(new_x > 5)
                {
                    new_x = 2;
        ...
        else if(current_x == 3 && current_y == 4 && distance == 6 && (currentPlayer == 0 || currentPlayer == 1)) //testing for case where piece is on different column
        {
            new_x = 5;
            new_y = 3;
        }
        else if(current_x == 3 && current_y == 3 && distance == 6 && (currentPlayer == 0 || currentPlayer == 1))
        {
            new_x = 5;
            new_y = 4;
        }
        else if(current_x == 3 && current_y == 3 && distance == 5 && (currentPlayer == 0 || currentPlayer == 1))
        {
            new_x = 5;
            new_y = 3;
        }
    ...
    int count[4] = {0, 0,0, 0};
    for(int i = 0; i < 8 ; i++){
        if(players[i].getx() == 5 && players[i].gety()== 5) count[i] = count[i]+1;
    }
    for (int i = 0; i < 4; i ++){
        if (count[i] == 2){
...
void Board::execute()
{
    ...
    while(pause == 'p')
    {
        ...
        if(currentPlayer == 0)
        {
            ...
            if(pieceNumber == 1)
            {
                if(players[0].getx() == 1 && players[0].gety() == 6) // it is at home
                {
                ...
                else   // it is not at home and already on board
                {
